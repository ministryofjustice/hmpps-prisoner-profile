...
import {
  ActiveCountryReferenceDataCodes,
  CountryReferenceDataCodes,
...
describe('referenceDataService', () => {
  ...
  describe('getReferenceData', () => {
    it('should get previously cached reference data', async () => {
      referenceDataStore.getReferenceData.mockResolvedValue(CountryReferenceDataCodes)
    ...
    it('should call API when reference data codes have not been previously cached', async () => {
      ...
      personIntegrationApiClient.getReferenceDataCodes.mockResolvedValue(CountryReferenceDataCodes)
    ...
    it('refreshes the cache if code cannot be found in the cache', async () => {
      const [newReferenceData, ...outdatedReferenceData] = CountryReferenceDataCodes
  ...
  describe('getActiveReferenceDataCodes', () => {
    it('should get previously cached reference data codes', async () => {
      ...
      expect(actual).toEqual(ActiveCountryReferenceDataCodes)
    })
