...
jest.mock('./utils/permissions/getOverviewAccessStatusCode', () => ({
  __esModule: true,
  default: jest.fn(),
}))

jest.mock('./utils/permissions/getMoneyAccessStatusCode', () => ({
  __esModule: true,
  default: jest.fn(),
}))

jest.mock('./utils/permissions/getCaseNotesAccessStatusCode', () => ({
  __esModule: true,
  default: jest.fn(),
}))
