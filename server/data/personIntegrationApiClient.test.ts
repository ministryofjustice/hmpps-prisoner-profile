...
describe('personIntegrationApiClient', () => {
  ...
  describe('using v1 endpoints', () => {
    beforeEach(() => {
      ...
      config.featureToggles.personEndpointsEnabled = false
    })
    ...
    describe('getReferenceDataCodes', () => {
      it('should return reference data codes', async () => {
        ...
        const output = await personIntegrationApiClient.getReferenceDataCodes(
  ...
  describe('using v2 endpoints', () => {
    ...
    describe('getReferenceDataCodes', () => {
      it('should return reference data codes', async () => {
        fakePersonIntegrationApi
          .get('/v2/reference-data/domain/COUNTRY/codes')
          .reply(200, CountryReferenceDataCodesMock)
    ...
    describe('getMilitaryRecords', () => {
      it('should get military records', async () => {
    ...
    describe('addDistinguishingMarkImage', () => {
      const response = { stream: image.stream, contentType: 'image/jpeg' }
      it('should add a distinguishing mark image', async () => {
