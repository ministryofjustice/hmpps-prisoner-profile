...
import { pagedCaseNotesMock } from './pagedCaseNotesMock'

export const findCaseNotesMock: FindCaseNotesResponse = {
  content: [...pagedCaseNotesMock.content],
  metadata: {
    totalElements: 80,
    page: 1,
    size: 20,
...
export const findCaseNotesMockPage2: FindCaseNotesResponse = {
  content: [
    {
      caseNoteId: '47018169',
...
export const emptyFindCaseNotesMock: FindCaseNotesResponse = {
  content: [],
  metadata: {
    totalElements: 0,
    page: 1,
...
export const findCaseNotesMockSorted: FindCaseNotesResponse = {
  content: [
    {
      caseNoteId: '47018169',
      offenderIdentifier: 'G6123VU',
...
export const findCaseNotesMockFiltered: FindCaseNotesResponse = {
  content: [
    {
      caseNoteId: '47018169',
      offenderIdentifier: 'G6123VU',
...
export const findPomCaseNotesMock: FindCaseNotesResponse = {
  content: [
    {
...
export const findSingleCaseNoteWithTypes = (
  prisonerNumber: string,
  type: string,
  subType: string,
): FindCaseNotesResponse => ({
  content: [
    {
      caseNoteId: 'f81d31cd-c2d9-4718-843f-dfade96ca468',
