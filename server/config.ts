...
export default {
  ...
  apis: {
    ...
    prisonApi: {
      ...
      timeout: {
        response: Number(get('PRISON_API_TIMEOUT_RESPONSE', 7500)),
        deadline: Number(get('PRISON_API_TIMEOUT_DEADLINE', 7500)),
      },
      agent: new AgentConfig(Number(get('PRISON_API_TIMEOUT_DEADLINE', 7500))),
    },
    prisonerSearchApi: {
