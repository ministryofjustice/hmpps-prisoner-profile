...
export default {
  ...
  apis: {
    ...
    prisonSearchApi: {
      ...
      timeout: {
        response: Number(get('OFFENDER_SEARCH_API_TIMEOUT_SECONDS', 20000)),
        deadline: Number(get('OFFENDER_SEARCH_API_TIMEOUT_SECONDS', 20000)),
      },
      agent: new AgentConfig(Number(get('OFFENDER_SEARCH_API_TIMEOUT_DEADLINE', 20000))),
    },
