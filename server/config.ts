...
export default {
  ...
  apis: {
    ...
    curiousApiUrl: {
      ...
      timeout: {
        response: Number(get('CURIOUS_API_URL_TIMEOUT_SECONDS', 10000)),
        deadline: Number(get('CURIOUS_API_URL_TIMEOUT_SECONDS', 10000)),
      },
      agent: new AgentConfig(Number(get('CURIOUS_API_URL_TIMEOUT_DEADLINE', 10000))),
    },
    whereaboutsApi: {
