...
describe('Validation middleware - Add Alert', () => {
  ...
  it('should fail validation with bad data', async () => {
    ...
    expect(result).toEqual([
      { text: 'Enter why you are creating this alert using 1,000 characters or less', href: '#description' },
...
describe('Validation middleware - Add more details', () => {
  ...
  it('should fail validation with text over 1000 characters', async () => {
    ...
    expect(result).toEqual([{ text: 'Enter your comments using 1,000 characters or less', href: '#description' }])
  })
})
