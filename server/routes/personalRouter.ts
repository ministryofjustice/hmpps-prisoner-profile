...
export default function personalRouter(services: Services): Router {
  ...
  router.use(
    ...
    getPrisonerData(services),
    featureFlagGuard(editProfileEnabled),
  ...
  router.use(
    `${basePath}`,
    getPrisonerData(services),
    featureFlagGuard(militaryHistoryEnabled),
    prisonerPermissionsGuard(prisonPermissionsService, {
  ...
  router.use(
    ...
    getPrisonerData(services),
    featureFlagGuard(editProfileEnabled),
    // TODO: edit language permission required:
    prisonerPermissionsGuard(prisonPermissionsService, { requestDependentOn: [PrisonerBasePermission.read] }),
    populateEditPageData(),
  ...
  const editRoute = ({
    ...
    submit,
    requiredPermission,
    featureFlagMethod = editProfileEnabled,
  }: {
    ...
    featureFlagMethod?: FeatureFlagMethod
  }) => {
    ...
    get(
      ...
      getPrisonerData(services),
      featureFlagGuard(featureFlagMethod),
  ...
  editRoute({
    ...
    featureFlagMethod: dietAndAllergyEnabled,
  })
  ...
  editRoute({
    ...
    // TODO: edit domestic status permission required:
    requiredPermission: PrisonerBasePermission.read,
  })
