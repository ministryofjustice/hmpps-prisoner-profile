...
describe('NationalityController', () => {
  ...
  const middleware = {
    ...
    inmateDetail: {
      ...inmateDetailMock,
      profileInformation: [
        { question: 'Nationality', resultValue: 'British', type: ProfileInformationType.Nationality },
        {
    ...
    describe('submit', () => {
      ...
      it('Sends a post success audit event', async () => {
        ...
        const expectedAuditEvent = {
          ...
          details: [
            { fieldName: nationalityFieldData.fieldName, previous: 'British', updated: 'FREN' },
