...
import GlobalEmailsController from './globalEmails/globalEmailsController'
...
export default function personalEditControllerFactory(
  ...
  return {
    ...
    globalEmailsController: new GlobalEmailsController(personalPageService, auditService),
