...
Cypress.Commands.add('setupHealthPings', ({ httpStatus }) => {
  ...
  cy.task('stubAdjudicationsApiPing', httpStatus)
  cy.task('stubAlertsApiPing', httpStatus)
  cy.task('stubCalculateReleaseDatesApiPing', httpStatus)
  cy.task('stubCaseNotesApiPing', httpStatus)
  cy.task('stubComplexityApiPing', httpStatus)
  cy.task('stubComponentsApiPing', httpStatus)
  cy.task('stubCuriousApiPing', httpStatus)
  cy.task('stubPlpApiPing', httpStatus)
  cy.task('stubIncentivesApiPing', httpStatus)
  cy.task('stubKeyworkerApiPing', httpStatus)
  cy.task('stubNonAssociationsApiPing', httpStatus)
  cy.task('stubPathfinderApiPing', httpStatus)
  cy.task('stubAllocationApiPing', httpStatus)
  cy.task('stubDeliusApiPing', httpStatus)
  cy.task('stubPrisonPersonApiPing', httpStatus)
  cy.task('stubRestrictedPatientApiPing', httpStatus)
  cy.task('stubSocApiPing', httpStatus)
  cy.task('stubWhereaboutsApiPing', httpStatus)
  cy.task('stubPrisonRegisterApiPing', httpStatus)
  cy.task('stubBookAVideoLinkApiPing', httpStatus)
  cy.task('stubManageUsersApiPing', httpStatus)
})
