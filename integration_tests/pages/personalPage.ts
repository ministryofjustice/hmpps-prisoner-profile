...
export default class PersonalPage extends Page {
  ...
  personalDetails = () => {
    ...
    return {
      ...
      dateOfBirth: (): PageElement => cardData('date-of-birth'),
      cityOrTownOfBirth: (): PageElement => cardData('city-or-town-of-birth'),
      countryOfBirth: (): PageElement => cardData('country-of-birth'),
      nationality: (): PageElement => cardData('nationality'),
      ethnicGroup: (): PageElement => cardData('ethnic-group'),
      religionOrBelief: (): PageElement => cardData('religion-or-belief'),
      sex: (): PageElement => cardData('sex'),
      sexualOrientation: (): PageElement => cardData('sexual-orientation'),
      marriageOrCivilPartnership: (): PageElement => cardData('marriage-or-civil-partnership'),
      numberOfChildren: (): PageElement => cardData('number-of-children'),
      otherLanguages: (): PageElement => cardData('other-languages'),
      dietAndFoodAllergies: (): PageElement => cardData('diet-and-food-allergies'),
      smokeOrVaper: (): PageElement => cardData('smoker-or-vaper'),
      domesticAbusePerpetrator: (): PageElement => cardData('domestic-abuse-perpetrator'),
      domesticAbuseVictim: (): PageElement => cardData('domestic-abuse-victim'),
      socialCareNeeded: (): PageElement => cardData('social-care-needed'),
      youthOffender: (): PageElement => cardData('youth-offender'),
      militaryRecords: () => ({
