...
context('Change distinguishing mark', () => {
  ...
  context('Page contents', () => {
    ...
    it('User can access the change scar page', () => {
      ...
      page.markDetails().bodyPart().should('contain.text', 'Arm')
      ...
      page
        ...
        .should(
          'contain.html',
          '<img src="/api/prison-person-image/019205c0-0f5f-7bef-9a24-d64db76ca24a" alt="Image of Scar on Arm" width="350px">',
        )
    })
    ...
    it('User can access the change mark page', () => {
      ...
      page.markDetails().bodyPart().should('contain.text', 'Leg')
      page.markDetails().location().should('contain.text', 'Leg - no specific location')
      ...
      page
        ...
        .should(
          'contain.html',
          '<img src="/api/prison-person-image/019205c0-0f5f-7bef-9a24-d64db76ca24a" alt="Image of Mark on Leg" width="350px">',
        )
    })
  })
})
