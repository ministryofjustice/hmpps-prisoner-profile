...
context('Alerts Page - Permissions', () => {
  context('Active alerts', () => {
    const visitPage = prisonerDataOverrides => {
      ...
      cy.setupPrisonApiAlertsPageStubs({ prisonerNumber: 'G6123VU', bookingId: 1102484, prisonerDataOverrides })
...
context('Non-Alerts API enabled prison', () => {
  context('Alerts Page - User does not have Update Alerts role', () => {
    ...
    context('No Active Alerts', () => {
      ...
      beforeEach(() => {
        cy.setupPrisonApiAlertsPageStubs({ prisonerNumber: 'A1234BC', bookingId: 1234567 })
